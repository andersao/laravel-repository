...
class RequestCriteria implements Criteria {
    ...
    public function apply($query, Repository $repository)
    {
        ...
        $search             = $this->request->get( Config::get('prettus-repository::criteria.params.search','search') , null);
        $searchFields       = $this->request->get( Config::get('prettus-repository::criteria.params.searchFields','searchFields') , null);
        $filter             = $this->request->get( Config::get('prettus-repository::criteria.params.filter','filter') , null);
        $orderBy            = $this->request->get( Config::get('prettus-repository::criteria.params.orderBy','orderBy') , null);
        $sortedBy           = $this->request->get( Config::get('prettus-repository::criteria.params.sortedBy','sortedBy') , 'asc');
    ...
    protected function parserFieldsSearch(array $fields = array(), array $searchFields =  null){
        ...
        if( !is_null($searchFields) && count($searchFields) ){
            ...
            $acceptedConditions = Config::get('prettus-repository::criteria.acceptedConditions', array('=','like') );
